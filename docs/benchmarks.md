...
| [RoboDojo](https://robodojo-benchmark.com/)                                           | 统一的仿真与真实世界通用机器人操作评测（42 个仿真任务、18 个真实任务） | sim/real split、任务子集、Isaac Sim 版本、XPolicyLab 适配、真实硬件、scene reset、评测次数 |
| [RoboTwin 2.0](https://github.com/RoboTwin-Platform/RoboTwin)                         | 双臂数字孪生任务与数据                                                 | 场景、物体组合、双臂动作格式                                                              |
